...
using Lunar.Console.UI.Screens;
...
public sealed class ConsoleGamePresenter
{
    ...
    private CombatResultDto ResolveCombatAction(CombatActionResult action, bool isBoss)
    {
        ...
        return action.Action switch
        {
            ...
            _ => new CombatResultDto { Success = false, Error = "Invalid action." }
        };
    }
}
